...
public class sieveGraphictwo {
	//increase the size of the canvas if numbers are not visible within boxes for higher integers
	...
	public static void createSquares( int gridCalculator, int n,int []primeArray,int red,
		...
		double offset = (HEIGHT_CANVAS*.20)/(sizeGrid+1);					// spaces will take up 20% of the axis
		int columnCounter =1;
		double lengthSquare=(HEIGHT_CANVAS*.80)/sizeGrid;					//squares will take up 80% of the x axis
